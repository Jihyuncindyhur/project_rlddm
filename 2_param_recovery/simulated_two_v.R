...
# data
rm(list=ls())
dat = read.csv('simulated_two_v_12sub.csv', header=TRUE)
...
sm <- rstan::stan_model('simulated_two_v.stan')
...
sim_two_s_12sub_50 = rstan::sampling(sm, data = dataList, pars = pars, init = pars_init,
                                       iter = 2000, warmup = 1000, chains = 4)

save(sim_two_s_12sub_50, file='sim_two_s_12sub_50.RData')
